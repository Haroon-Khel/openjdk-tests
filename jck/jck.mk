...
EXEC_RUNTIME_JDWP = $(TEST_ROOT)/jck/jck-jdwp-test-drive.sh '$(GEN_JTB_GENERIC)' '$(START_AGENT_GENERIC)' '$(EXEC_RUNTIME_TEST)' $(TEST_JDK_HOME) $(JCK_ROOT) $(JCK_VERSION_NUMBER)
